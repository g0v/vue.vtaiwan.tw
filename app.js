...
var results = {}; // export const get = (uri) => {
//   if (!results[uri]) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_lazyload__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_offline__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_offline___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_offline__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__App_vue__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_vuex_router_sync__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__filters__ = __webpack_require__(22);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_vuex_router_sync__["sync"])(__WEBPACK_IMPORTED_MODULE_4__store__["a" /* default */], __WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */]); // register global utility filters.

Object.keys(__WEBPACK_IMPORTED_MODULE_7__filters__).forEach(function (key) {
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].filter(key, __WEBPACK_IMPORTED_MODULE_7__filters__[key]);
});
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_1_vue_lazyload__["a" /* default */]);
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_2_vue_offline___default.a); // create the app instance.
// here we inject the router and store to all child components,
// making them available everywhere as `this.$router` and `this.$store`.

var app = new __WEBPACK_IMPORTED_MODULE_0_vue__["default"](_objectSpread({
  router: __WEBPACK_IMPORTED_MODULE_5__router__["a" /* default */],
  store: __WEBPACK_IMPORTED_MODULE_4__store__["a" /* default */],
  filters: __WEBPACK_IMPORTED_MODULE_7__filters__
}, __WEBPACK_IMPORTED_MODULE_3__App_vue___default.a)); // expose the app, the router and the store.
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_app_footer_vue__ = __webpack_require__(115);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_2__js_request__["a" /* default */].get('https://talk.vtaiwan.tw/c/meta-data.json').then(function (response) {
      var topics = response.data.topic_list.topics.slice(1); // console.log(response.data.topic_list.topics[0].title + ' removed')
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getContactus: function getContactus(id) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__js_request__["a" /* default */].get('https://talk.vtaiwan.tw/c/contactus/l/latest.json?page=' + id) //caxios.get('https://talk.pdis.nat.gov.tw/c/pdis-site/how-we-work-track/l/latest.json?page='+ id) //pdis
      .then(function (response) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Detail_Topic_Slide_vue__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Detail_Topic_NextStage_vue__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Detail_Topic_Discussion_vue__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Detail_Topic_Timeline_vue__ = __webpack_require__(109);
...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        try {
          for (var _iterator2 = rawlinks.filter(function (link) {
            ...
            /* 篩出 typeform 連結 */
                ...
                dType.type = 'typeform';
                link = link.replace(/.*\((.*)\)/, "$1");
                dType.embeder = "<iframe src='".concat(link, "' frameborder='0' width='100%' height='1000px'></iframe>");
              }
              /* 篩出 hackpad 連結 (deprecated) */
              else if (link.indexOf("hackpad") > -1) {
                  dType.type = 'hackpad';
                  dType.embeder = "Hackpad is moving to Dropbox Paper. Use external <a href='".concat(link, "' target='_blank'>link</a> instead.");
                }
                /* 篩出 圖片連結 */
                else if (/.*\.jpg/.test(link)) {
                    dType.type = 'img';
                    link = link.replace(/.*\((.*)\)/, "$1");
                    dType.embeder = "<img src='".concat(link, "' />");
                  } else {
                    var item = {};
                    ...
                    dType.type = 'default';
                    dType.embeder = "Please check <a href='".concat(item.link, "' target='_blank'>").concat(item.text, "</a>");
                  }
          }
        } catch (err) {
  ...
  created: function created() {
    this.discussionType(this.articleId);
    /* first time call */
  },
  updated: function updated() {
    $('.ui.accordion').accordion();
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_request__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Detail_Topic_Timeline_ParticipationLink_vue__ = __webpack_require__(110);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_Slideshow_vue__ = __webpack_require__(120);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__home_ProposalTab_vue__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_News_vue__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__home_observe_vue__ = __webpack_require__(121);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    Info: __WEBPACK_IMPORTED_MODULE_3__home_observe_vue___default.a // Catagories,
  ...
  methods: {
    ...
    handleResize: function handleResize() {
      if (typeof window !== 'undefined') {
        ...
        this.myIdx = this.onMobile ? 0 : 1;
        /* default tab for mobile and screen */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__home_observe_fancybox_vue__ = __webpack_require__(122);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    window.addEventListener('scroll', this.mTitleHitEvent); // $(window).scroll(this.mTitleHitEvent)
  ...
  methods: {
    mTitleHitEvent: function mTitleHitEvent() {
      ...
      var el = $("#" + btn_name);
      if (!el.length)
        /* check if m-title exist */
        return 0;
      var mTop = el.offset().top;
      /* m-title's position */
      ...
      if (isScollingOn && !isSent) {
        /* do not double sent */
        this.$emit('stickTo', btn_name);
        /* sent event trigger to parent comp */
...
module.exports = function (a, b) {
  var naturalSort = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Home_vue__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_HowToUse_vue__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Intro_vue__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Detail_Topic_vue__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_ContactUs_vue__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_app_navbar_search_vue__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Subscribe_vue__ = __webpack_require__(114);
...
/* harmony default export */ __webpack_exports__["a"] = (new __WEBPACK_IMPORTED_MODULE_1_vue_router__["default"]({
  ...
  routes: [{
    ...
    path: '/how-to-use',
    name: 'howTo',
    component: __WEBPACK_IMPORTED_MODULE_3__components_HowToUse_vue___default.a
  }, {
    path: '/intro',
    name: 'intro',
    ...
    path: '/contactus',
    name: 'contactus',
    component: __WEBPACK_IMPORTED_MODULE_6__components_ContactUs_vue___default.a
  }, {
    path: '/search',
    name: 'search',
    component: __WEBPACK_IMPORTED_MODULE_7__components_app_navbar_search_vue___default.a
  }, {
    path: '/subscribe',
    name: 'subscribe',
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_offline_plugin_runtime__ = __webpack_require__(26);
...
// module
exports.push([module.i, "\n*[data-v-1dc163e9] {\n  box-sizing: border-box;\n}\nbody[data-v-1dc163e9] {\n  font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n  font-size: 2.5vmin;\n  padding: 0;\n  margin: 0;\n  visibility: visible;\n  opacity: 1;\n  transition: opacity 0.5s ease;\n}\n.fade-enter[data-v-1dc163e9],\n.fade-leave-active[data-v-1dc163e9] {\n  opacity: 0;\n}\n.fade-leave-active[data-v-1dc163e9],\n.fade-enter-active[data-v-1dc163e9] {\n  transition: opacity .3s ease;\n}\n.component[data-v-1dc163e9] {\n  position: relative;\n}\n.component h1[data-v-1dc163e9], .component h2[data-v-1dc163e9], .component h3[data-v-1dc163e9], .component h4[data-v-1dc163e9], .component h5[data-v-1dc163e9], .component h6[data-v-1dc163e9], .component p[data-v-1dc163e9] {\n    font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n}\n.component h1 a[data-v-1dc163e9], .component h2 a[data-v-1dc163e9], .component h3 a[data-v-1dc163e9], .component h4 a[data-v-1dc163e9], .component h5 a[data-v-1dc163e9], .component h6 a[data-v-1dc163e9], .component p a[data-v-1dc163e9] {\n      cursor: pointer !important;\n      color: dimgray;\n      border-bottom: 1px dashed lightgray;\n}\n.component strong[data-v-1dc163e9] {\n    font-weight: 900;\n    color: black;\n}\n@media only screen and (max-width: 767px) {\n.fat-only[data-v-1dc163e9] {\n    display: none !important;\n}\n}\n@media only screen and (min-width: 768px) {\n.thin-only[data-v-1dc163e9] {\n    display: none !important;\n}\n}\n.component[data-v-1dc163e9] {\n  position: relative;\n  margin: 0 auto;\n  max-width: 100%;\n}\nimg[data-v-1dc163e9] {\n  width: 3.5em;\n  height: auto;\n  vertical-align: bottom;\n}\nimg.hidden[data-v-1dc163e9] {\n    display: none;\n}\n.ui.icon[data-v-1dc163e9] {\n  margin: 0 1ch;\n}\n@media only screen and (max-width: 767px) {\n.ui.icon[data-v-1dc163e9] {\n      font-size: x-small;\n}\n}\na.ui.icon.button[data-v-1dc163e9] {\n  background-color: #333;\n}\n", ""]);
...
// module
exports.push([module.i, "\n*[data-v-237d3245] {\n  box-sizing: border-box;\n}\nbody[data-v-237d3245] {\n  font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n  font-size: 2.5vmin;\n  padding: 0;\n  margin: 0;\n  visibility: visible;\n  opacity: 1;\n  transition: opacity 0.5s ease;\n}\n.fade-enter[data-v-237d3245],\n.fade-leave-active[data-v-237d3245] {\n  opacity: 0;\n}\n.fade-leave-active[data-v-237d3245],\n.fade-enter-active[data-v-237d3245] {\n  transition: opacity .3s ease;\n}\n.component[data-v-237d3245] {\n  position: relative;\n}\n.component h1[data-v-237d3245], .component h2[data-v-237d3245], .component h3[data-v-237d3245], .component h4[data-v-237d3245], .component h5[data-v-237d3245], .component h6[data-v-237d3245], .component p[data-v-237d3245] {\n    font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n}\n.component h1 a[data-v-237d3245], .component h2 a[data-v-237d3245], .component h3 a[data-v-237d3245], .component h4 a[data-v-237d3245], .component h5 a[data-v-237d3245], .component h6 a[data-v-237d3245], .component p a[data-v-237d3245] {\n      cursor: pointer !important;\n      color: dimgray;\n      border-bottom: 1px dashed lightgray;\n}\n.component strong[data-v-237d3245] {\n    font-weight: 900;\n    color: black;\n}\n@media only screen and (max-width: 767px) {\n.fat-only[data-v-237d3245] {\n    display: none !important;\n}\n}\n@media only screen and (min-width: 768px) {\n.thin-only[data-v-237d3245] {\n    display: none !important;\n}\n}\n.body[data-v-237d3245] {\n  text-align: justify;\n}\n.meta[data-v-237d3245] {\n  color: dimgray;\n  font-size: 80%;\n}\n.meta span[data-v-237d3245]:not(:last-child)::after {\n    content: '|';\n    margin: 0 1ch;\n}\n.author[data-v-237d3245] {\n  float: right;\n}\n", ""]);
...
// module
exports.push([module.i, "\n*[data-v-2e520813] {\n  box-sizing: border-box;\n}\nbody[data-v-2e520813] {\n  font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n  font-size: 2.5vmin;\n  padding: 0;\n  margin: 0;\n  visibility: visible;\n  opacity: 1;\n  transition: opacity 0.5s ease;\n}\n.fade-enter[data-v-2e520813],\n.fade-leave-active[data-v-2e520813] {\n  opacity: 0;\n}\n.fade-leave-active[data-v-2e520813],\n.fade-enter-active[data-v-2e520813] {\n  transition: opacity .3s ease;\n}\n.component[data-v-2e520813] {\n  position: relative;\n}\n.component h1[data-v-2e520813], .component h2[data-v-2e520813], .component h3[data-v-2e520813], .component h4[data-v-2e520813], .component h5[data-v-2e520813], .component h6[data-v-2e520813], .component p[data-v-2e520813] {\n    font-family: Roboto, \"Microsoft JhengHei\", \"Heiti TC\", sans-serif;\n}\n.component h1 a[data-v-2e520813], .component h2 a[data-v-2e520813], .component h3 a[data-v-2e520813], .component h4 a[data-v-2e520813], .component h5 a[data-v-2e520813], .component h6 a[data-v-2e520813], .component p a[data-v-2e520813] {\n      cursor: pointer !important;\n      color: dimgray;\n      border-bottom: 1px dashed lightgray;\n}\n.component strong[data-v-2e520813] {\n    font-weight: 900;\n    color: black;\n}\n@media only screen and (max-width: 767px) {\n.fat-only[data-v-2e520813] {\n    display: none !important;\n}\n}\n@media only screen and (min-width: 768px) {\n.thin-only[data-v-2e520813] {\n    display: none !important;\n}\n}\n.ui.container[data-v-2e520813] {\n  min-height: 15em;\n  margin: 1em auto 2em auto;\n  padding: 5px 1px;\n  /* to prevent overlapped border */\n  overflow: hidden;\n}\n.ui.container .ui.card[data-v-2e520813] {\n    margin: 0;\n}\n.ui.container .ui.card .image[data-v-2e520813] {\n      background-position: center;\n      background-size: cover;\n      height: 12rem;\n}\n.ui.container .ui.card .content[data-v-2e520813] {\n      text-align: justify;\n}\n.ui.container .ui.card .content p[data-v-2e520813] {\n        font-size: 50%;\n}\n.ui.container .ui.card .extra.content[data-v-2e520813] {\n      line-height: 1;\n}\n.ui.container .swiper-container-horizontal > .swiper-pagination-bullets[data-v-2e520813] {\n    bottom: -10px;\n}\n", ""]);
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1dc163e9"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2e520813"
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-237d3245"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), 1) : _vm._l((_vm.steps), function(step, idx) {
    return _c('Box', {
      attrs: {
        "list": _vm.mySort(step.dataName),
        "desc": step.description,
      ...
      on: {
        "stickTo": function($event) {
          return _vm.onStickTo(idx, $event)
        }
      }
    })
  })], 2)])])
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("Facebook")]), _c('router-link', {
    staticClass: "item",
    attrs: {
      "to": "/subscribe",
      "exact": "",
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v("vTaiwan 說明")]), _c('div', {
    staticClass: "ui left aligned text container"
  }, [_c('p', [_vm._v("📣這裡是 vTaiwan 虛擬法規調適平台的工作小組社團，歡迎自由加入成為社群的貢獻者，幫助台灣在制定／修改法規的路上更加開放透明、促進更多的公民參與：)")])]), _c('h1', {
    staticClass: "ui center aligned icon header"
  }, [_c('i', {
    staticClass: "circular flag icon"
  }), _vm._v("我可以怎麼開始幫忙呢？")]), _c('div', {
    staticClass: "ui left aligned text container"
  }, [_c('h2', [_vm._v("🗣️提供意見：針對議題提供想法或意見")]), _c('p', [_vm._v("vTaiwan 網站上有各式各樣的議題在進行意見徵集，歡迎留下你的意見、經驗，或想法，提供給行政部門參考。")]), _c('h2', [_vm._v("📣擴散議題：讓意見徵集被看到")]), _c('p', [_vm._v("協助轉貼、擴散 vTaiwan 網站上正在進行的意見徵集的議題給任何人，尤其是讓有可能會被該議題影響到的人們（利害關係人）或該領域的專家，讓他們能有機會在徵集意見期間內提出意見。")]), _c('h2', [_vm._v("✍️編輯文字：讓議題更加淺顯易懂")]), _c('p', [_vm._v("如果你覺得某個 vTaiwan 上的議題的說明會讓公民很難懂，歡迎動手修改，你可以建立一個比較淺顯易懂的版本貼在社團，讓法律專長的社群朋友確認內容，形式不拘，不管是文字、圖像、懶人包或顏文字都可以。如果你有擅長法律白話文的熱心朋友，也歡迎介紹他幫忙。")]), _c('p', [_vm._v("當然，如果想修改 vTaiwan 網站的說明文字也是沒有問題的唷。")]), _c('h2', [_vm._v("🎨影像設計：讓議題更吸睛")]), _c('p', [_vm._v("vTaiwan 也徵求擅長影像設計的朋友，讓 vTaiwan 上的議題可以透過影像的力量更容易地被傳遞出去，得到更多公民意見的回饋。")]), _c('h2', [_vm._v("📫意見回饋：提出想法")]), _c('p', [_vm._v("如果你有任何關於能讓 vTaiwan 變得更好的發想，歡迎用各種方式告訴我們！")]), _c('h2', [_vm._v("㊙️其實你想做什麼都可以：沒有人是萬能的")]), _c('p', [_vm._v("除了把意見回饋給我們，或是你就直接動手吧，「不要問為什麼『沒有人』做這個，先承認你自己就是『沒有人』。」\n但如果你在過程中需要幫助，歡迎在社團或slack上和大家聊聊。")]), _c('h2', [_vm._v("❤️或是參加我們的實體活動 "), _c('a', {
    attrs: {
  ...
  }, [_vm._v("vTaiwan Facebook")])])]), _c('ul', [_c('li', [_c('a', {
    attrs: {
      "href": "https://vtw.link/",
      "target": "_blank"
    }
  }, [_vm._v("Hackfoldr")])])]), _c('ul', [_c('li', [_c('a', {
    attrs: {
      "href": "https://g0v.hackpad.com/ep/pad/static/h",
      "target": "_blank"
    }
  }, [_vm._v("聊天室：g0v-tw slack「#vtaiwan」")])])])])])])
}]}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          return _vm.goAnchor('.proposalTab')
        }
      }
    }, [_c('i', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.OfflineOnly),
      expression: "OfflineOnly"
    }],
    staticClass: "offline"
  }, [_vm._v("This part is visible only if user is offline")]), _c('footNav')], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('router-link', {
      ...
      staticClass: "percent"
    }, [_vm._v(_vm._s(Math.floor(item.total - item.progress)))])])]), _vm._v("天")]) : _vm._e(), ((item.status === '意見徵集' && item.total == item.progress)) ? _c('div', {
      staticClass: "progressbar"
    }, [_vm._v("最後一天")]) : _vm._e(), ((item.status === '意見徵集' && item.progress > item.total)) ? _c('div', {
      staticClass: "progressbar"
    }, [_vm._v("徵集結束")]) : _vm._e()] : _vm._e()], 2), _c('div', {
      staticClass: "content"
    }, [_c('h3', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), 0)]), _c('tbody', _vm._l((_vm.timeline), function(ev, idx) {
    return _c('tr', [_c('td', {
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1dc163e9&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app_footer.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-1dc163e9&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app_footer.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-237d3245&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home_observe_fancybox.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-237d3245&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home_observe_fancybox.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e520813&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home_News.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2e520813&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./home_News.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3162a75b!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Detail_Topic_Timeline_ParticipationLink.vue", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3162a75b!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Detail_Topic_Timeline_ParticipationLink.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
